...
const translations = {
  en: {
    ...
    manageMedications: "Manage your medications and refills",
    ...
    refillRequestFor: "Refill request sent for",
  ...
  hi: {
    ...
    addNewPrescription: "नई दवा जोड़ें",
    prescribedBy: "द्वारा निर्धारित",
    active: "सक्रिय",
    pending_refill: "रिफिल लंबित",
    completed: "पूर्ण",
    reminderSet: "रिमाइंडर सेट",
    reminderFor: "के लिए रिमाइंडर सेट",
    refillRequested: "रिफिल का अनुरोध किया गया",
    refillRequestFor: "के लिए रिफिल अनुरोध भेजा गया",
  ...
  pa: {
    ...
    manageMedications: "ਆਪਣੀਆਂ ਦਵਾਈਆਂ ਅਤੇ ਰਿਫਿਲ ਦਾ ਪ੍ਰਬੰਧ ਕਰੋ",
    prescriptionDetails: "ਦਵਾਈ ਵੇਰਵਾ",
    dosageInstructions: "ਖੁਰਾਕ ਹਿਦਾਇਤਾਂ",
    duration: "ਮਿਆਦ",
    refillsRemaining: "ਬਾਕੀ ਰਿਫਿਲ",
    possibleSideEffects: "ਸੰਭਾਵਿਤ ਮਾੜੇ ਪ੍ਰਭਾਵ",
    callDoctor: "ਡਾਕਟਰ ਨੂੰ ਕਾਲ ਕਰੋ",
    nextDose: "ਅਗਲੀ ਖੁਰਾਕ",
    remind: "ਯਾਦ ਦਿਵਾਓ",
    requestRefill: "ਰਿਫਿਲ ਦੀ ਬੇਨਤੀ ਕਰੋ",
    addNewPrescription: "ਨਵੀਂ ਦਵਾਈ ਜੋੜੋ",
    prescribedBy: "ਦੁਆਰਾ ਨਿਰਧਾਰਿਤ",
    active: "ਸਰਗਰਮ",
    pending_refill: "ਰਿਫਿਲ ਬਾਕੀ",
    completed: "ਪੂਰਾ",
    reminderSet: "ਰਿਮਾਈਂਡਰ ਸੈੱਟ",
    reminderFor: "ਲਈ ਰਿਮਾਈਂਡਰ ਸੈੱਟ",
    refillRequested: "ਰਿਫਿਲ ਦੀ ਬੇਨਤੀ ਕੀਤੀ ਗਈ",
    refillRequestFor: "ਲਈ ਰਿਫਿਲ ਬੇਨਤੀ ਭੇਜੀ ਗਈ",
